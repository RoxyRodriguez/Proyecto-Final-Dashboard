...
import { getCitapendiente } from "../../conexion/conexionCita";
import { Link } from "react-router-dom";

const CitasRouter = () => {
  const [dataCitapendiente, setCitaPendiente] = useState([]);

  useEffect(() => {
    getCitapendiente().then((objCta) => {
      setCitaPendiente(objCta);
    });
  }, []);
          ...
          <div className="container-xl mt-5">
            <div className="row g-3 mt-5 mb-4 align-items-center justify-content-between">
              <div className="col-auto">
                <h1 className="app-page-title mb-0">Citas Pendientes</h1>
              </div>
              <div className="col-auto">
                  ...
                  <div className="app-card-body">
                    ...
                    <div className="table-responsive">
                      <table className="table app-table-hover mb-0 text-left">
                        ...
                        <tbody>
                          {dataCitapendiente.map((objpac) => {
                            return (
                              <tr>
                                <td className="cell">{objpac.paciente}</td>
                                <td className="cell">
                                  <span className="truncate">
                                    {objpac.servicio}
                                  </span>
                                </td>
                                <td className="cell">{objpac.fecha}</td>
                                <td className="cell">
                                  <span>{objpac.hora}</span>
                                </td>
                                <td className="cell">
                                  <a
