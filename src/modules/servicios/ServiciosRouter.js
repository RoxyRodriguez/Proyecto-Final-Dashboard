...
import { getServicioAll } from "../../conexion/conexionServicio";

const ServiciosRouter = () => {

	const [dataServicio, setServicio] = useState([]);

	useEffect(() => {
		getServicioAll().then((objCta)=>{
			setServicio(objCta)
	  });
		    ...
		    <div className="container-xl mt-5">			    
			    <div className="row g-3 mt-5 mb-4 align-items-center justify-content-between">
				    <div className="col-auto">
			            <h1 className="app-page-title mb-0">Servicios</h1>
				    </div>
					<div className="col-auto">
						    ...
						    <div className="app-card-body">
							    <div className="table-responsive">
							        <table className="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												<th className="cell">Tipo Servicio</th>
												<th className="cell">Serivicio</th>
												<th className="cell">Estado</th>
											</tr>
										</thead>
										<tbody>
											{
												dataServicio.map((objpac)=>{
													return (
														<tr>
															<td className="cell">{objpac.tipo_servicio}</td>
															<td className="cell"><span className="truncate">{objpac.servicio}</span></td>
															<td className="cell">{objpac.estado}</td>
